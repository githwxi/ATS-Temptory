...
//
  val () = the_s2rtenv_add ($SYM.symbol_EFF0, S2TEsrt s2rt_eff0) // effects
//
  val () = the_s2rtenv_add ($SYM.symbol_FLOAT, S2TEsrt s2rt_float) // floats
  val () = the_s2rtenv_add ($SYM.symbol_STRING, S2TEsrt s2rt_string) // strings
//
// HX: pre-defined impredicative sorts
//
  val () = the_s2rtenv_add ($SYM.symbol_TBOX, S2TEsrt s2rt_type)
  val () = the_s2rtenv_add ($SYM.symbol_TFLT, S2TEsrt s2rt_t0ype)
//
...
//
  val () = the_s2rtenv_add ($SYM.symbol_VTBOX, S2TEsrt s2rt_vtype)
  val () = the_s2rtenv_add ($SYM.symbol_VTFLT, S2TEsrt s2rt_vt0ype)
//
(*
