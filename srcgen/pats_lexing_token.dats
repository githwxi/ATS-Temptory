...
implement ABSTBOX = T_ABSTYPE (TBOX_int)
implement ABSTFLT = T_ABSTYPE (TFLT_int)
implement ABSPROP = T_ABSTYPE (PROP_int)
implement ABSVIEW = T_ABSTYPE (VIEW_int)

implement ABSVTBOX = T_ABSTYPE (VTBOX_int)
implement ABSVTFLT = T_ABSTYPE (VTFLT_int)

implement CASE = T_CASE (CK_case)
implement CASE_pos = T_CASE (CK_case_pos)
implement CASE_neg = T_CASE (CK_case_neg)

implement DATATYPE = T_DATATYPE (TBOX_int)
implement DATAPROP = T_DATATYPE (PROP_int)
implement DATAVIEW = T_DATATYPE (VIEW_int)
implement DATAVTYPE = T_DATATYPE (VTBOX_int)

implement FIX = T_FIX (TBOX_int)
implement FIXAT = T_FIX (TFLT_int)
...
implement LAM = T_LAM (TBOX_int)
implement LAMAT = T_LAM (TFLT_int)
implement LLAM = T_LAM (VTBOX_int)
implement LLAMAT = T_LAM (VTFLT_int)
...
(* ****** ****** *)
//
implement TBOX = T_TYPE (TBOX_int)
implement TBOX_pos = T_TYPE (TBOX_pos_int)
implement TBOX_neg = T_TYPE (TBOX_neg_int)
//
implement TFLT = T_TYPE (TFLT_int)
implement TFLT_pos = T_TYPE (TFLT_pos_int)
implement TFLT_neg = T_TYPE (TFLT_neg_int)
//
(*
...
(* ****** ****** *)
//
implement VTBOX = T_TYPE (VTBOX_int)
implement VTBOX_pos = T_TYPE (VTBOX_pos_int)
implement VTBOX_neg = T_TYPE (VTBOX_neg_int)
//
implement VTFLT = T_TYPE (VTFLT_int)
implement VTFLT_pos = T_TYPE (VTFLT_pos_int)
implement VTFLT_neg = T_TYPE (VTFLT_neg_int)
//
(*
...
implement TYPEDEF = T_TYPEDEF (TFLT_int)
implement PROPDEF = T_TYPEDEF (PROP_int)
implement VIEWDEF = T_TYPEDEF (VIEW_int)
implement VTYPEDEF = T_TYPEDEF (VTFLT_int)
...
implement WITHTYPE = T_WITHTYPE (TFLT_int)
implement WITHPROP = T_WITHTYPE (PROP_int)
implement WITHVIEW = T_WITHTYPE (VIEW_int)
implement WITHVTYPE = T_WITHTYPE (VTFLT_int)
...
implement DLRDELAY = T_DLRDELAY(TBOX_int)
implement DLRLDELAY = T_DLRDELAY(VTBOX_int)
...
implement
DLRVCOPYENV_VT = T_DLRVCOPYENV (VTBOX_int)
...
//
val () = ins ("abstbox", ABSTBOX)
val () = ins ("abstflt", ABSTFLT)
val () = ins ("absvtbox", ABSVTBOX)
val () = ins ("absvtflt", ABSVTFLT)
//
val () = ins ("absimpl", T_ABSIMPL)
val () = ins ("absreimpl", T_ABSREIMPL)
//
val () = ins ("as", T_AS)
//
val () = ins ("and", T_AND)
