...
//
  ...
  val () = emit_text (out, "#include \"temptory_memalloca.h\"\n")
  val () = emit_text (out, "#include \"temptory_exception.h\"\n")
...
val () = emit_text (out, "#include \"temptory_runtime.c\"\n")
val () = emit_text (out, "#include \"temptory_runtime_memory.c\"\n")
val () = emit_text (out, "#ifndef _TEMPTORY_EXCEPTION_NONE_\n")
val () = emit_text (out, "#include \"temptory_runtime2_dats.c\"\n")
val () = emit_text (out, "#ifndef _TEMPTORY_RUNTIME_TRYWITH_NONE_\n")
val () = emit_text (out, "#include \"temptory_runtime_trywith.c\"\n")
