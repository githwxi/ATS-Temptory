...
(
  ...
  lexing_polarity (buf, pos, TBOX, TBOX_pos, TBOX_neg)
// end of [lexing_TBOX]
fun
lexing_TFLT
(
  ...
  lexing_polarity (buf, pos, TFLT, TFLT_pos, TFLT_neg)
// end of [lexing_TBOX]
//
(*
fun
...
(
  ...
  lexing_polarity (buf, pos, VTYPE, VTYPE_pos, VTYPE_neg)
// end of [lexing_VTYPE]
*)
//
fun
...
(
  ...
  lexing_polarity (buf, pos, VTBOX, VTBOX_pos, VTBOX_neg)
// end of [lexing_VTBOX]
fun
lexing_VTFLT
(
  ...
  lexing_polarity (buf, pos, VTFLT, VTFLT_pos, VTFLT_neg)
// end of [lexing_VTBOX]
//
(*
fun
...
| LS_ABST () when
    ...
    lexbufpos_token_reset (buf, pos, ABSTFLT)
  end
*)
(*
| LS_ABSVT () when
    testing_literal (buf, pos, "@ype") >= 0 => let
    val () = strptr_free (mystr) in
    lexbufpos_token_reset (buf, pos, ABSVTFLT)
  end
*)
(*
| LS_ABSVIEWT () when
