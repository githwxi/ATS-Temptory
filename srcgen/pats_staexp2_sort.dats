...
val
s2tb_int =
S2RTBASpre($SYM.symbol_INT)
val
s2tb_addr =
S2RTBASpre($SYM.symbol_ADDR)
val
s2tb_bool =
S2RTBASpre($SYM.symbol_BOOL)
//
(*
...
val
s2tb_eff0 =
S2RTBASpre($SYM.symbol_EFF0) // for sets of effects
//
val
s2tb_float =
S2RTBASpre($SYM.symbol_FLOAT) // for floating points
val
s2tb_string =
S2RTBASpre($SYM.symbol_STRING) // for literal strings
//
(*
val
s2tb_tkind = S2RTBASpre($SYM.symbol_TKIND) // for template arguments
*)
//
in // in of [local]
//
...
//
implement s2rt_eff0 = S2RTbas s2tb_eff0 // for tracking effects
//
implement s2rt_float = S2RTbas s2tb_float // for floating points
implement s2rt_string = S2RTbas s2tb_string // for literal strings
//
(*
...
//
val s2tb_type: s2rtbas = S2RTBASimp(TBOX_int, $SYM.symbol_TBOX)
val s2tb_type_pos: s2rtbas = S2RTBASimp(TBOX_pos_int, $SYM.symbol_TBOX)
val s2tb_type_neg: s2rtbas = S2RTBASimp(TBOX_neg_int, $SYM.symbol_TBOX)
//
val s2tb_t0ype: s2rtbas = S2RTBASimp(TFLT_int, $SYM.symbol_TFLT)
val s2tb_t0ype_pos: s2rtbas = S2RTBASimp(TFLT_pos_int, $SYM.symbol_TFLT)
val s2tb_t0ype_neg: s2rtbas = S2RTBASimp(TFLT_neg_int, $SYM.symbol_TFLT)
//
...
//
val s2tb_vtype: s2rtbas = S2RTBASimp(VTBOX_int, $SYM.symbol_VTBOX)
val s2tb_vtype_pos: s2rtbas = S2RTBASimp(VTBOX_pos_int, $SYM.symbol_VTBOX)
val s2tb_vtype_neg: s2rtbas = S2RTBASimp(VTBOX_neg_int, $SYM.symbol_VTBOX)
//
val s2tb_vt0ype: s2rtbas = S2RTBASimp(VTFLT_int, $SYM.symbol_VTFLT)
val s2tb_vt0ype_pos: s2rtbas = S2RTBASimp(VTFLT_pos_int, $SYM.symbol_VTFLT)
val s2tb_vt0ype_neg: s2rtbas = S2RTBASimp(VTFLT_neg_int, $SYM.symbol_VTFLT)
//
in // in of [local]
...
| PROP_int => s2rt_prop
| VIEW_int => s2rt_view
| VTBOX_int => s2rt_vtype
| VTFLT_int => s2rt_vt0ype
//
| TBOX_pos_int => s2rt_type_pos
| TBOX_neg_int => s2rt_type_neg
| TFLT_pos_int => s2rt_t0ype_pos
| TFLT_neg_int => s2rt_t0ype_neg
//
...
//
| VTBOX_pos_int => s2rt_vtype_pos
| VTBOX_neg_int => s2rt_vtype_neg
| VTFLT_pos_int => s2rt_vt0ype_pos
| VTFLT_neg_int => s2rt_vt0ype_neg
//
| _ => let
//
    val () = prerr_interror ()
