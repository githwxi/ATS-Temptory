...
extern
fun{}
board_rforall1(!board): bool
extern
fun{}
board_rforall1$test(int): bool
...
board_rforall1(xs) =
(
list0_vt_rforall1<int>(xs)
) where
{
implement
list0_vt_rforall1$test<int>(x0) = board_rforall1$test<>(x0)
}
...
{
  implement
  board_rforall1$test<>(x0) = glseq_rforall1$test<int>(x0)
}
